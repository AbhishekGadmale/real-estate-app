...
export default function StatCard({ value, suffix = '', label, index = 0 }) {
    ...
    return (_jsxs(motion.div, { ref: ref, initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.5, delay: index * 0.1 }, className: "text-center", children: [_jsxs("div", { className: "text-4xl md:text-5xl font-bold text-white mb-2", children: [count.toLocaleString(), suffix] }), _jsx("div", { className: "text-blue-200 text-sm md:text-base", children: label })] }));
}
